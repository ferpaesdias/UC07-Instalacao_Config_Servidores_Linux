...
2.  Edite `/etc/chrony/chrony.conf`:
    ...
    Comente a linha `pool 2.debian.pool.ntp.org iburst` e, abaixo dela, adicione os servidores do [NTP.br](ntp.br). Ficará assim:
...
4.  Teste o Chrony com o comando abaixo:
    ...
    A saída do comando deve ser semelhante a abaixo:
...
## 📦 Passo 2: Instalação do Kea DHCP
...
## 🚀 Passo 4: Validação e Início do Serviço
